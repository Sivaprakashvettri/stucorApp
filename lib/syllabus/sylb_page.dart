                  ...
                  child: Container(
                    ...
                    child: Column(
                      ...
                      children: [
                        /// TITLE
                        const Text(
                          "Regulation 2021 (UG / PG) Syllabus",
                          style: TextStyle(
                            fontSize: 20,
                        ...
                        RichText(
                          text: TextSpan(
                            ...
                            children: [
                              const TextSpan(
                                text:
                                    "Anna University syllabus is available. Kindly download the syllabus provided below and share with classmates. ",
                              ),
                              TextSpan(
                                text: "Click here",
                                style:
                        ...
                        _tableSection(
                          leftTitle: "PG DEGREE",
                          leftRows: const ["All Regulations"],
                        ),
    ...
    return Row(
      children: [
        Expanded(
          child: Column(
            children: [
              _cell(leftTitle, bold: true),
              ...leftRows.map((e) => _cell(e)),
            ],
          ),
        ),
        Expanded(
          child: Column(
            children: [
              _cell("SYLLABUS", bold: true),
              ...leftRows.map(
                (_) => _cell("Download", color: Colors.blue),
              ),
            ],
          ),
        ),
