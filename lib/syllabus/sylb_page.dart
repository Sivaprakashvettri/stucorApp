...
class SylbPage extends StatelessWidget {
  const SylbPage({super.key});
              ...
              child: Row(spacing: 30,
                ...
                children: [
                   Padding(
                            ...
                            child: Text("Regulation 2021 (UG/PG) Syllabus",style: TextStyle(fontSize: 20,color: const Color.fromARGB(255, 9, 19, 135)),),
                          ),
                          ...
                          child: Padding(
                            ...
                            child: Column(
                              ...
                              TextSpan(text: " to Share clasmates. ompleting accordingly .",style: TextStyle(fontSize: 20),)
                         ...
                         Padding(
                           ...
                           child: Row(mainAxisAlignment: MainAxisAlignment.center,
                            children: [
                              Column(children: [
                                ...
                                child: Padding(
                                  ...
                                  child: Text("UG DEGREE",style: TextStyle(fontWeight: FontWeight.bold,fontSize: 10),),
                                ),),
                                Container(height: 20,width: 100,decoration: BoxDecoration(shape: BoxShape.rectangle
                                ,border: Border.all(color: Colors.black)),
                                child: Padding(
                                  padding: const EdgeInsets.only(left: 15.0),
                                  child: Text("CSE",style: TextStyle(color: Colors.black,fontSize: 10),),
                                ),),
                                 Container(height: 20,width: 100,decoration: BoxDecoration(shape: BoxShape.rectangle
                                ,border: Border.all(color: Colors.black)),
                                child: Padding(
                                  padding: const EdgeInsets.only(left: 15.0),
                                  child: Text("IT",style: TextStyle(color: Colors.black,fontSize: 10),),
                                ),),
                                 Container(height: 20,width: 100,decoration: BoxDecoration(shape: BoxShape.rectangle
                                ,border: Border.all(color: Colors.black)),
                                child: Padding(
                                  padding: const EdgeInsets.only(left: 15.0),
                                  child: Text("ECE",style: TextStyle(color: Colors.black,fontSize: 10),),
                                ),),
                                 Container(height: 20,width: 100,decoration: BoxDecoration(shape: BoxShape.rectangle
                                ,border: Border.all(color: Colors.black)),
                                child: Padding(
                                  padding: const EdgeInsets.only(left: 15.0),
                                  child: Text("EEE",style: TextStyle(color: Colors.black,fontSize: 10),),
                                ),),
                                 Container(height: 20,width: 100,decoration: BoxDecoration(shape: BoxShape.rectangle
                                ,border: Border.all(color: Colors.black)),
                                child: Padding(
                                  padding: const EdgeInsets.only(left: 15.0),
                                  child: Text("AI&DS",style: TextStyle(color: Colors.black,fontSize: 10),),
                                ),),
                                 Container(height: 20,width: 100,decoration: BoxDecoration(shape: BoxShape.rectangle
                                ,border: Border.all(color: Colors.black)),
                                child: Padding(
                                  padding: const EdgeInsets.only(left: 15.0),
                                  child: Text("AI&ML",style: TextStyle(color: Colors.black,fontSize: 10),),
                                ),),
                                Container(height: 20,width: 100,decoration: BoxDecoration(shape: BoxShape.rectangle
                                ,border: Border.all(color: Colors.black)),
                                child: Padding(
                                  ...
                                  child: Row(
                                    children: [
                                      Text("CSE",style: TextStyle(color: Colors.black,fontSize: 10),),
                                      Text("(DATA SCINCE)",style: TextStyle(color: Colors.black,fontSize: 10),)
                                    ],
                                  ),
                                ),),
                                  Container(height: 20,width: 100,decoration: BoxDecoration(shape: BoxShape.rectangle
                                ...
                                child: Padding(
                                  ...
                                  child: Row(
                                    children: [
                                      Text("CSE",style: TextStyle(color: Colors.black,fontSize: 10),),
                                      Text("(CYBER SEC)",style: TextStyle(color: Colors.black,fontSize: 10),)
                                    ],
                                  ),
                                ),),
                                 Container(height: 20,width: 100,decoration: BoxDecoration(shape: BoxShape.rectangle
                                ...
                                child: Padding(
                                  padding: const EdgeInsets.only(left: 15.0),
                                  child: Text("MECH",style: TextStyle(color: Colors.black,fontSize: 10),),
                                ),),
                                 Container(height: 20,width: 100,decoration: BoxDecoration(shape: BoxShape.rectangle
                                ,border: Border.all(color: Colors.black)),
                                child: Padding(
                                  padding: const EdgeInsets.only(left: 15.0),
                                  child: Text("CIVIL",style: TextStyle(color: Colors.black,fontSize: 10),),
                                ),),
                                Container(height: 20,width: 100,decoration: BoxDecoration(shape: BoxShape.rectangle
                                ,border: Border.all(color: Colors.black)),
                                child: Padding(
                                  padding: const EdgeInsets.only(left: 15.0),
                                  child: Text("Other DEGERSS",style: TextStyle(color: Colors.black,fontSize: 10),),
                                ),)
                            ...
                            child: Padding(
                              padding: const EdgeInsets.only(left: 15.0),
                              child: Text("SYLLABUS",style: TextStyle(color: Colors.black,fontSize: 10,fontWeight: FontWeight.bold),),
                            ),),
                            Container(height: 20,width: 100,decoration: BoxDecoration(shape: BoxShape.rectangle
                            ,border: Border.all(color: Colors.black)),
                            child: Padding(
                          ...
                          children: [
                            Column(children: [
                              ...
                              child: Padding(
                                padding: const EdgeInsets.only(left: 15.0),
                                child: Text("All Regulations",style: TextStyle(color: Colors.black,fontSize: 10),),
                              ),),
