              ...
              child: Row(spacing: 30,
                ...
                children: [
                   Padding(
                            ...
                            child: Text("  medalist ofAU Affiliated colleges",style: TextStyle(fontSize: 20,color: const Color.fromARGB(255, 9, 19, 135)),),
                          ),
                    
                          Padding(
                            padding: const EdgeInsets.only(right: 235.0),
                            child: Text(" published 1 omnths ago | jul 25 - 02:42 pm ",style: TextStyle(fontSize: 10,color: Colors.grey),),
                          ),
                          Padding(
                          ...
                          child: Padding(
                            ...
                            child: Column(
                              ...
                              TextSpan(text: " to Share clasmates we have attached those details for your reference below.",style: TextStyle(fontSize: 20),)
                          ...
                          Padding(
                            ...
                            children: [
                              Column(children: [
                                Container(height: 30,width: 130,decoration: BoxDecoration(shape: BoxShape.rectangle
                                ,border: Border.all(color: Colors.black)),
                                child: Padding(
                                  padding: const EdgeInsets.only(left: 15.0),
                                  child: Text("CONVOCATION",style: TextStyle(color: Colors.black,fontSize: 10,fontWeight: FontWeight.bold),),
                                ),),
                                Container(height: 30,width: 130,decoration: BoxDecoration(shape: BoxShape.rectangle
                                ,border: Border.all(color: Colors.black)),
                                child: Padding(
                                  padding: const EdgeInsets.only(left: 15.0),
                                  child: Text("45th convocation",style: TextStyle(color: Colors.black,fontSize: 10),),
                                ),),
                                ...
                                child: Padding(
                                  padding: const EdgeInsets.only(left: 15.0),
                                  child: Text("44th convocation",style: TextStyle(color: Colors.black,fontSize: 10),),
                                ),),
                                Container(height: 30,width: 130,decoration: BoxDecoration(shape: BoxShape.rectangle
                                ,border: Border.all(color: Colors.black)),
                                child: Padding(
                                  padding: const EdgeInsets.only(left: 15.0),
                                  child: Text("43rd convocation",style: TextStyle(color: Colors.black,fontSize: 10),),
                                ),),
                                Container(height: 30,width: 130,decoration: BoxDecoration(shape: BoxShape.rectangle
                                ,border: Border.all(color: Colors.black)),
                                child: Padding(
                                  padding: const EdgeInsets.only(left: 15.0),
                                  child: Text("42nd convocation",style: TextStyle(color: Colors.black,fontSize: 10),),
                                ),),
                                Container(height: 30,width: 130,decoration: BoxDecoration(shape: BoxShape.rectangle
                                ,border: Border.all(color: Colors.black)),
                                child: Padding(
                                  padding: const EdgeInsets.only(left: 15.0),
                                  child: Text("41st convocation",style: TextStyle(color: Colors.black,fontSize: 10),),
                                ),),
                            ...
                            child: Padding(
                              padding: const EdgeInsets.only(left: 15.0),
                              child: Text("MEDALIST",style: TextStyle(color: Colors.black,fontSize: 10,fontWeight: FontWeight.bold),),
                            ),),
