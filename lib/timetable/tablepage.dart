                           ...
                           child: Row(mainAxisAlignment: MainAxisAlignment.center,
                            children: [
                              Column(children: [
                                ...
                                child: Padding(
                                  padding: const EdgeInsets.only(left: 15.0),
                                  child: Text("Regulations 2021",style: TextStyle(color: Colors.black,fontSize: 10),),
                                ),),
                                Container(height: 20,width: 100,decoration: BoxDecoration(shape: BoxShape.rectangle
                                ,border: Border.all(color: Colors.black)),
                                child: Padding(
                                  ...
                                  child: Row(
                                    children: [
                                      Text("Addictions-I",style: TextStyle(color: Colors.blue,fontSize: 10),),
                                      Text("(New)",style: TextStyle(color: Colors.red,fontSize: 10),)
                                    ],
                                  ),
                                ),),
                                  Container(height: 20,width: 100,decoration: BoxDecoration(shape: BoxShape.rectangle
                                ...
                                child: Padding(
                                  ...
                                  child: Row(
                                    children: [
                                      Text("Changes-I",style: TextStyle(color: Colors.blue,fontSize: 10),),
                                      Text("(New)",style: TextStyle(color: Colors.red,fontSize: 10),)
                                    ],
                                  ),
                                ),),
                                ...
                                child: Padding(
                                  padding: const EdgeInsets.only(left: 15.0),
                                  child: Text("Other Regulations",style: TextStyle(color: Colors.black,fontSize: 10),),
                                ),)
                            ...
                            child: Padding(
                              padding: const EdgeInsets.only(left: 15.0),
                              child: Text("Download",style: TextStyle(color: Colors.black,fontSize: 10),),
                            ),),
                            Container(height: 20,width: 100,decoration: BoxDecoration(shape: BoxShape.rectangle
                            ,border: Border.all(color: Colors.black)),
                            child: Padding(
