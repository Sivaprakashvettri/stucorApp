...
class Schedulefirst extends StatelessWidget {
  const Schedulefirst({super.key});
              ...
              child: Row(spacing: 30,
                ...
                children: [
                   Padding(
                            ...
                            child: Text(" Practical schedule forApr/may 2025 semester timetabe-AU Affiliated clg",style: TextStyle(fontSize: 20,color: const Color.fromARGB(255, 9, 19, 135)),),
                          ),
                          ...
                          Padding(
                            ...
                            children: [
                              Column(children: [
                                ...
                                child: Padding(
                                  padding: const EdgeInsets.only(left: 15.0),
                                  child: Text("UG/PG(1 to 8 th sem)",style: TextStyle(color: Colors.black,fontSize: 10),),
                                ),),
                                 Container(height: 30,width: 130,decoration: BoxDecoration(shape: BoxShape.rectangle
                                ,border: Border.all(color: Colors.black)),
                                child: Padding(
                                  padding: const EdgeInsets.only(left: 5.0),
                                  child:RichText(text: TextSpan(children: [TextSpan(text:"UG/PG(10th sem-b.Arch)",style: TextStyle(color: Colors.black,fontSize: 10),),
                                  TextSpan(text: "(Revised)",style: TextStyle(color: Colors.red,fontSize: 10),)
