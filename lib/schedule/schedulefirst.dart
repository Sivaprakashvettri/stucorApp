...
class Schedulefirst extends StatelessWidget {
                        ...
                        RichText(
                          text: TextSpan(
                            ...
                            children: [
                              const TextSpan(
                                text:
                                    "Anna University practical schedule is available. Kindly download the schedule provided below and prepare accordingly. ",
                              ),
                              TextSpan(
                                text: "Click here",
                                style:
  ...
  /// RICH CELL (FOR REVISED TEXT)
  Widget _cellRich(String text, String extra) {
    return Container(
      height: 32,
      alignment: Alignment.center,
      decoration:
