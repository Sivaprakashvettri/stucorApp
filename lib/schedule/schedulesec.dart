                        ...
                        RichText(
                          text: TextSpan(
                            ...
                            children: [
                              const TextSpan(
                                text:
                                    "Anna University academic schedule is available. Kindly download the schedule provided below and prepare accordingly. ",
                              ),
                              TextSpan(
                                text: "Click here",
                                style:
                            ...
                            Expanded(
                              child: Column(
                                children: [
                                  ...
                                  _cell("Download", color: Colors.blue),
                                  _cell("Download", color: Colors.blue),
                                ],
                              ),
                            ),
